...
internal sealed class ConfigureProcessInboxJob(IOptions<InboxOptions> options) : IConfigureOptions<QuartzOptions>
{
    ...
    public void Configure(QuartzOptions options)
    {
        ...
        options
            ...
            .AddTrigger(configure => 
                configure
                     .ForJob(jobName)
                     .WithSimpleSchedule(schedule => schedule.WithIntervalInSeconds(_inboxOptions.IntervalInSeconds).RepeatForever()));
    }
}
